#### 使用Solidity [Standard Json-Input](https://solidity.readthedocs.io/en/v0.5.8/using-the-compiler.html#compiler-input-and-output-json-description) format形式进行验证
